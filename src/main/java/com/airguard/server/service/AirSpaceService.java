...
public class AirSpaceService {
    ...
    public void addPlane(Plane incomingPlane) {
        // חישובים גיאוגרפיים התחלתיים קבועים
        ...
        // תיעוד האירוע: פתיחת שורה חדשה בטבלת FlightLog
        ...
        // הזרקה לזיכרון ה-RAM כדי שיוצג ברדאר שבאתר
